...
import dev.tigr.mesh.impl.wrapper.render.BufferBuilderMesh;
...
public class MeshStatics {
    ...
    public static CPacketUseEntity createCPacketUseEntityInteract(Entity entity, dev.tigr.mesh.util.math.Hand hand, boolean sneaking) {
    ...
    public static CPacketUseEntity createCPacketUseEntityInteractAt(Entity entity, dev.tigr.mesh.util.math.Hand hand, Vec3d pos, boolean sneaking) {
