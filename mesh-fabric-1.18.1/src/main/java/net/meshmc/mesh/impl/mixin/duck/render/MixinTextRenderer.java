package net.meshmc.mesh.impl.mixin.duck.render;
...
public abstract class MixinTextRenderer implements net.meshmc.mesh.impl.mixininterface.render.TextRenderer {
