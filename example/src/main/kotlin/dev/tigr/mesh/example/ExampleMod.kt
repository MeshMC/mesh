...
class ExampleMod: Mesh.Initializer {
    ...
    private val HELMET_IMAGE = LocationIdentifier("examplemod", "helmet.png")
    ...
    val hudRenderEventListener = EventListener<HudRenderEvent> {
        ...
        buffer.construct(
            Vertex(50.0, 0.0, Color.GREEN),
            Vertex(0.0, 0.0, Color.GREEN),
            Vertex(0.0, 50.0, Color.GREEN),
            Vertex(0.0, 50.0, Color.BLUE),
            Vertex(50.0, 50.0, Color.BLUE),
            Vertex(50.0, 0.0, Color.BLUE)
        )
        buffer.draw()
