...
/**
 * Used for wrapping collections.
 *
 * It is assumed that B is a subclass of A and that all elements of the collection
 * are instances of B.
 *
...
public class CollectionWrapper<A, B> extends AbstractMesh<Collection<B>> implements Collection<A> {
    public CollectionWrapper(Collection<B> value) {
        super(value);
    }
