...
public class EntityZombieVillagerMesh<T extends net.minecraft.entity.monster.EntityZombieVillager> extends EntityZombieMesh<T> implements EntityZombieVillager<T> {
